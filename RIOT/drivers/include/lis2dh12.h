...
/**
 * @brief   read any register of accelerometer
 *
 * @param[in] dev       device descriptor
 * @param[in] buffer    save the reading
 * @param[in] registre  address of the register to read
*/
void lis2dh12_read_click_event(const lis2dh12_t *dev, uint8_t *buffer, uint8_t registre);


/**
 * @brief   initializate interruption
 *
 * @param[in] dev       device descriptor
 */
void lis2dh12_init_int(const lis2dh12_t *dev);

/**
 * @brief   initializate threshold of event1
 *
 * @param[in] dev       device descriptor
 */
void lis2dh12_init_ths1(const lis2dh12_t *dev);

/**
 * @brief   initializate threshold of event2
 *
 * @param[in] dev       device descriptor
 */
void lis2dh12_init_ths2(const lis2dh12_t *dev);

/**
 * @brief   assuring that LIR_INT is on, so every reading register is cleared
 *
 * @param[in] dev       device descriptor
 */
void lis2dh12_init_reg5(const lis2dh12_t *dev);
